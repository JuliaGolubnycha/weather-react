    ...
    if (unit === "celsius"){
        return(
            <div>
                ...
                <Days temp0={temp0} temp1={temp1} temp2={temp2} temp3={temp3} temp4={temp4}/>
            </div>
        );
    } else {
        return (
            <div>
                ...
                <MainWeather mood={mood} humidity={humidity} wind={wind}/>
                <Days temp0={Math.round(temp0*(9/5)+32)} temp1={Math.round(temp1*(9/5)+32)} temp2={Math.round(temp2*(9/5)+32)} temp3={Math.round(temp3*(9/5)+32)} temp4={Math.round(temp4*(9/5)+32)}/>
            </div>
        );
    }
